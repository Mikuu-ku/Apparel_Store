        ...
        <?php if($success): ?>
            <div class="login-success-overlay">
                ...
                <p style="font-size: 12px; color: #888;">
                    <?php echo isset($_SESSION['pending_cart']) ? "Saving your item to cart..." : "Authenticating credentials..."; ?>
                </p>
            </div>
        <?php else: ?>
            <div class="auth-logo">
            ...
            <?php if (isset($_GET['msg']) && $_GET['msg'] == 'please_login'): ?>
                <div class="info-msg" style="background: #f0f0f0; color: #333; padding: 10px; font-size: 11px; margin-bottom: 15px; border-left: 3px solid #000; letter-spacing: 1px;">
