...
<head>
    ...
    <style>
        ...
        .pass-wrapper { position: relative; width: 100%; margin-bottom: 20px; }
...
<div class="auth-wrapper">
    <div class="auth-form-container">
        ...
        <?php else: ?>
            ...
            <div id="js-error" class="error-msg" style="display:none; color: #ff0000; font-size: 10px; margin-bottom: 15px; letter-spacing: 1px; text-transform: uppercase; font-weight: bold;"></div>

            <?php if(!empty($error)): ?>
                <div class="error-msg" style="color: #ff0000; font-size: 10px; margin-bottom: 15px; letter-spacing: 1px; text-transform: uppercase; font-weight: bold;"><?= $error ?></div>
            <?php endif; ?>

            <form method="POST" class="auth-form" id="loginForm" novalidate>
                <input type="email" name="email" id="email" placeholder="EMAIL ADDRESS" required 
                       style="width: 100%; padding: 12px; margin-bottom: 15px; border: 1px solid #ddd; outline: none; font-size: 12px; letter-spacing: 1px; box-sizing: border-box;">
                ...
                <button type="submit" name="login" 
                        style="width: 100%; padding: 14px; background: #000; color: #fff; border: none; text-transform: uppercase; letter-spacing: 2px; font-weight: bold; cursor: pointer; transition: 0.3s; margin-top: 5px;">
                    Login
                </button>
            </form>

            <div class="auth-footer" style="margin-top: 25px; font-size: 10px; letter-spacing: 1.5px; color: #888;">
