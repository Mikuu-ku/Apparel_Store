...
if (isset($_POST['add'])) {
    ...
    mysqli_query($conn, "INSERT INTO products (name, description, price, size, color, stock_s, stock_m, stock_l, stock_xl) 
...
if (isset($_POST['update'])) {
    ...
    mysqli_query($conn, "UPDATE products SET name='$name', description='$desc', price='$price', size='$size', color='$color', stock='$stock_s', '$stock_m', '$stock_l', '$stock_xl' WHERE id=$id");
